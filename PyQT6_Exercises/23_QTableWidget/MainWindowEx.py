...
for folder in os.listdir('.\\PyQT6_Exercises\\23_QTableWidget'):
    sys.path.append(os.path.abspath('.\\PyQT6_Exercises\\23_QTableWidget'+folder))
...
class MainWindowEx(Ui_MainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.products=self.fileFactory.readData(".\\PyQT6_Exercises\\23_QTableWidget\\database.json",Product)
    ...
    def processSave(self):
        ...
        if product.Price<10000000:
            ...
            itemPrice.setBackground(Qt.GlobalColor.yellow)
        self.tableWidgetProduct.setItem(row, 2, itemPrice)
        self.fileFactory.writeData(".\\PyQT6_Exercises\\23_QTableWidget\\database.json", self.products)
