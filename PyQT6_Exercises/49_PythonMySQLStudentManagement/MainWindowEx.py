import os, sys
for folder in os.listdir('.\\PyQT6_Exercises\\49_PythonMySQLStudentManagement'):
    sys.path.append(os.path.abspath('.\\PyQT6_Exercises\\49_PythonMySQLStudentManagement'+folder))
import base64
import traceback
...
class MainWindowEx(Ui_MainWindow):
    def __init__(self):
        super().__init__()
        self.default_avatar="images/ic_logo.png"
        self.id = None
        self.code = None
        self.name = None
        self.age = None
        ...
        try:
            ...
            if item != None:
                ...
                if self.avatar != None:
                    ...
                    pixmap = QPixmap("images/ic_logo.png")
